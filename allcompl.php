...
<div class="container">
     <body>   
        ...
        $username =$_SESSION["username"];
                          $result = mysqli_query($con,"SELECT * FROM complaints WHERE username='$username'");
                          ...
                          <tr>  
                               ...
                               <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal"><a href="delete_compl.php?del=<?php echo $row["c_id"];?> ">Delete</a></button></td>

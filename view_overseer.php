...
<br><br><br><BR><br>    
  ...
  <table class="styled-table" border="2" style="margin-left:30px;">
         ...
         include("Database/connection.php");
         $d=$row['Section'];
                          $result = mysqli_query($con,"SELECT * FROM `tbl_employreg` where `Type_Id`=2 and Section='$d'");
...
<script type="application/javascript">
 ...
 if(document.frmcstreg.search.value == "")
    {
      alert("Enter the section to search Overseer.");

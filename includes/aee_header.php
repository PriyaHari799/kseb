...
<body>
  ...
  <i class="fa fa-lightbulb-o" style="font-size:36px"></i>
      ...
      <ul class="nav-links">
      <li>
          <a href="aee_profile.php">
            <i class='bx bx-user' ></i>
            <span class="links_name">Profile</span>
          </a>
        </li>
        <li>
          <a href="aee_change_pass.php">
            <i class='bx bx-cog' ></i>
        ...
        <li>
          <a href="view_emp_leave.php">
         
          <i class="fa fa-file-o" style="font-size:18px"></i>
            <span class="links_name">Approve Leave</span>
          </a>
        </li> 

       
        <li>
          <a href="conrequests.php">
         
          <i class='bx bx-box' ></i>
            <span class="links_name">Connection Requests</span>
          </a>
        </li>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">AEE Portal</span>
      </div>

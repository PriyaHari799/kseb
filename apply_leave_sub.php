...
?>
    ...
    <a href="view_leave_sub.php">View Leave History</a>
...
&nbsp;leaves.
      ...
      <form method="post" action="apply_leave_suben.php" name="frmcstreg" onSubmit="return validatecstreg()">

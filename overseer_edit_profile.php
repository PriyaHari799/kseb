...
header("location:overseer_profile.php");
}
...
<tr>
    <td><a href="overseer_profile.php"><button type="button" class="btn btn-primary btn-arrow-left"><i class='fas fa-angle-double-left'></i>Back</button></a></td>

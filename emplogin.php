...
<body>
  ...
  <div class="container">
    <center><img src="images/4.jpg" alt="" class="img-fluid" width="25%" height="25%"></center><br>
    ...
    <div class="content">
      <form class="login-form" action="employ_login.php" method="post" name="frmcstreg" onSubmit="return validatecstreg()">
        <div class="user-details">
          ...
          <p class="message"><b>Not registered?</b> <a href="employereg.php"><b>Create an account</b></a></p>
        </div>

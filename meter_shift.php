...
$u=$_POST["username"];
    ...
    $h=$_POST["reason"];
		$d=$_POST["district"];
    $v=$_POST["village"];
		$cont="INSERT INTO `tbl_metershift` (`username`,`consumer`, `mobile`,`reason`,`district`,`village`,`date`,`status`) VALUES('$u','$e','$f','$h','$d','$v',curdate(),'Pending')";
				$res=mysqli_query($con,$cont);
				header('location:meter_shift_status.php');
...
<div class="container">
    ...
    <div class="card text mb-3" style="width: 0rem; font-size:16px;">

</div>
    <div class="title">Digital Meter Shift Request</div>
    <div class="content">
      ...
      <form method="post" action="#" name="frmcstreg" onSubmit="return validatecstreg()">
        ...
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="number" name="mobile" value="<?php echo $row['phone']?>" id="mobile" placeholder="Mobile Number" readonly>
          </div>
      ...
      <option value="Kasargode">Kasaragode</option>
          ...
          <div class="input-box">
            <span class="details">Reason for Meter Shift</span>
            <textarea class="form-control" rows="2" id="comment" name="reason" placeholder="Enter the reason"></textarea>
          </div>
...

{
  ...
  var optionArray=['changanacherry|Changanacherry','kangazha|Kangazha','Ponkunnam|ponkunnam','Manimala|manimala','karukachal|Karukachal','kurichy|Kurichy','kanjirappally|Kanjirappally'
...
<script type="application/javascript">
  function validatecstreg()
  {
    ...
    {
      alert("Kindly enter the reason for meter shift.");

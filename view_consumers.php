...
<body>
  ...
  <section class="home-section">
    <nav>
      ...
      <form action="search1.php" method="post" name="frmcstreg" onSubmit="return validatecstreg()">
      <div class="">
     
        <input type="text" placeholder="Search Consumers Here..." name="search" style="width:250px; height: 40px;">

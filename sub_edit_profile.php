...
<hr>
<form action="sub_edit_p.php" method="POST" name="frmcstreg" onSubmit="return validatecstreg()">
<table class="table">
<tr>
    <td>Name:</td>
...
<tr>
    <td>Section:</td>
    <td><input type="text" name="section" class="form-control" id="exampleInputPassword1" value="<?php echo $row['Section']?>"/></td>
</tr>



<tr>
    <td><a href="sub_profile.php"><button type="button" class="btn btn-primary btn-arrow-left">Back</button></a></td>
...
<script type="application/javascript">
  ...
  var emailExp = /^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/; //Variable to validate Email ID
    ...
    {
      alert("Kindly enter your section.");
